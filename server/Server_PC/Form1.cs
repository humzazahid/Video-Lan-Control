...
namespace Server_PC
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                if (radioButton5.Checked)
                {
                    ...
                    currentMsg = "movie" + textBox5.Text;
                    sendData(currentMsg);
                   
                    currentMsg = "\nMedia Player started" + comboBox1.SelectedItem.ToString() + " Ip";
        ...
        private void keyCl(object sender, KeyEventArgs e)
        {
           

        }

        private void keyt(object sender, KeyEventArgs e)
        {
        ...
        {
            currentMsg = "control" + "forward";
            sendData(currentMsg);
            axWindowsMediaPlayer1.Ctlcontrols.fastForward();
            currentMsg = "\nMedia Player Forwarded" + comboBox1.SelectedItem.ToString() + " Ip";
            this.Invoke(new rcvData(addNotification));
            recvDt = comboBox1.SelectedItem.ToString();
        }
        ...
        {
            currentMsg = "control" + "pause";
            sendData(currentMsg);
            axWindowsMediaPlayer1.Ctlcontrols.pause();
            currentMsg = "\nMedia Player paused" + comboBox1.SelectedItem.ToString() + " Ip";
            this.Invoke(new rcvData(addNotification));
            recvDt = comboBox1.SelectedItem.ToString();
        }
        ...
        {
            currentMsg = "control" + "stop";
            sendData(currentMsg);
            axWindowsMediaPlayer1.Ctlcontrols.stop();
            currentMsg = "\nMedia Player stop" + comboBox1.SelectedItem.ToString() + " Ip";
            this.Invoke(new rcvData(addNotification));
            recvDt = comboBox1.SelectedItem.ToString();
        }
        ...
        {
            currentMsg = "control" + "backward";
            sendData(currentMsg);
            axWindowsMediaPlayer1.Ctlcontrols.fastReverse();
            currentMsg = "\nMedia Player Backward" + comboBox1.SelectedItem.ToString() + " Ip";
            this.Invoke(new rcvData(addNotification));
            recvDt = comboBox1.SelectedItem.ToString();
        }
        ...
        private void btnVolumeUp_Click(object sender, EventArgs e)
        {
            ...
            currentMsg = "control" + "volumeu";
            sendData(currentMsg);
            axWindowsMediaPlayer1.settings.volume = vol;
            currentMsg = "\nMedia Player VolumeUp" + comboBox1.SelectedItem.ToString() + " Ip";
            this.Invoke(new rcvData(addNotification));
            recvDt = comboBox1.SelectedItem.ToString();
        }
        ...
        private void btnButtonDown_Click(object sender, EventArgs e)
        {
            ...
            currentMsg = "control" + "volumed";
            sendData(currentMsg);
            axWindowsMediaPlayer1.settings.volume = vol;
            currentMsg = "\nMedia Player VolumeDown" + comboBox1.SelectedItem.ToString() + " Ip";
            this.Invoke(new rcvData(addNotification));
            recvDt = comboBox1.SelectedItem.ToString();
        }
        ...
        {
            currentMsg = "control" + "close";
            sendData(currentMsg);
            axWindowsMediaPlayer1.close();
            currentMsg = "\nMedia Player Closed" + comboBox1.SelectedItem.ToString() + " Ip";
            this.Invoke(new rcvData(addNotification));
            recvDt = comboBox1.SelectedItem.ToString();
        }
    }
    ...
    class Transmit_File
    {
        ...
        public void transfer_file(string filename, string ip_addr)
        {
            ...
            try
            {
                ...
                MessageBox.Show("File Transfer to " + ip_addr +" is Completed and stored in Debug program resources ");
            }
            catch (Exception er)
            {
